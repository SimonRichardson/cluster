...
// Source: github.com/SimonRichardson/cluster/pkg/ingester (interfaces: Queue)

package mocks

import (
	ingester "github.com/SimonRichardson/cluster/pkg/ingester"
...
func (_m *MockQueue) Dequeue() (ingester.ReadSegment, error) {
	ret := _m.ctrl.Call(_m, "Dequeue")
	ret0, _ := ret[0].(ingester.ReadSegment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (_m *MockQueue) Enqueue() (ingester.WriteSegment, error) {
	ret := _m.ctrl.Call(_m, "Enqueue")
	ret0, _ := ret[0].(ingester.WriteSegment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
